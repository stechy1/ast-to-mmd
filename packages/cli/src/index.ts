...
import { astToMmd } from './app';
import { readFileSync } from 'fs';
import { UuidBlockIdGenerator } from './app/block-id-generator/uuid-block-id-generator';

clear();
console.log(figlet.textSync('AST-to-MMD CLI', { horizontalLayout: 'full' }));

const version = JSON.parse(readFileSync(path.resolve(__dirname, '../../../../', 'package.json'), { encoding: 'utf-8' })).version;
